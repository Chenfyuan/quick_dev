...
import ${package}.module.sys.model.response.SysUserVO;
...
@RequestMapping(SysConstant.SYS_MODULE_CONTEXT_PATH + RcConstant.Version.HTTP_API_VERSION_V1 + "/sys/users")
@RestController
public class AdminSysUserController {
    ...
    @GetMapping
    public ApiResult<PageResult<SysUserVO>> list(PageParam pageParam, AdminListSysUserDTO dto) {

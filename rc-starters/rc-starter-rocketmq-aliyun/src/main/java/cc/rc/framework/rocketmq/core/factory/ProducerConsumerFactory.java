...
package cc.rc.framework.rocketmq.core.factory;
...
public class ProducerConsumerFactory {
	...
	public static Producer getProducer(Map<String, Object> consumerContainer, RocketMessage rocketMessage, CommonMessage commonMessage){
		String producerConsumerKey = cc.rc.framework.rocketmq.core.factory.ProducerConsumerFactory.getProducerConsumerKey(rocketMessage, commonMessage);
	...
	public static OrderProducer getProducer(Map<String, Object> consumerContainer, RocketMessage rocketMessage, OrderMessage orderMessage){
		String producerConsumerKey = cc.rc.framework.rocketmq.core.factory.ProducerConsumerFactory.getProducerConsumerKey(rocketMessage, orderMessage);
	...
	public static TransactionProducer getProducer(Map<String, Object> consumerContainer, RocketMessage rocketMessage, TransactionMessage transactionMessage){
		String producerConsumerKey = cc.rc.framework.rocketmq.core.factory.ProducerConsumerFactory.getProducerConsumerKey(rocketMessage, transactionMessage);

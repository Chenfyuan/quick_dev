...
package cc.rc.framework.rocketmq.aspect;

import cc.rc.framework.rocketmq.annotation.CommonMessage;
import cc.rc.framework.rocketmq.annotation.OrderMessage;
import cc.rc.framework.rocketmq.annotation.RocketMessage;
import cc.rc.framework.rocketmq.annotation.TransactionMessage;
import cc.rc.framework.rocketmq.core.factory.ShardingKeyFactory;
import cc.rc.framework.rocketmq.core.factory.StartDeliverTimeFactory;
import cc.rc.framework.rocketmq.core.factory.ThreadPoolFactory;
import cc.rc.framework.rocketmq.core.utils.AspectUtils;
import cc.rc.framework.rocketmq.core.utils.InterceptRocket;
...
public class RocketAspect implements ApplicationContextAware {
    ...
    @Pointcut("@annotation(cc.rc.framework.rocketmq.annotation.CommonMessage)")
    public void commonMessagePointcut() {
        log.debug("Start sending CommonMessage");
    }

    @Pointcut("@annotation(cc.rc.framework.rocketmq.annotation.OrderMessage)")
    public void orderMessagePointcut() {
        log.debug("Start sending OrderMessage");
    }

    @Pointcut("@annotation(cc.rc.framework.rocketmq.annotation.TransactionMessage)")

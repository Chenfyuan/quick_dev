package cc.rc.module.knife4j.config;
...
public class Knife4jAutoConfiguration {
    ...
    private ApiInfo apiInfo(){
        return new ApiInfoBuilder()
                .title(rcProperties.getKnife4j().getTitle())
                .description(rcProperties.getKnife4j().getDescription())
                .termsOfServiceUrl("")
                .contact(ApiInfo.DEFAULT_CONTACT)
                .version(rcProperties.getKnife4j().getVersion())
                .build();
    }
